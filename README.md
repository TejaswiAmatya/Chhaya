...
- **Bilingual feed** — toggle between English and South Asian languages; stories auto-translate via Groq API (llama-3.3-70b-versatile) / Anthropic API (SONNET 4)
...
- **Light a virtual diyo** (oil lamp) — write posi
- **Light a diyo** — tap any lamp to enter its community space and read affirmations from women who've been there
- **Leave an affirmation** — write your own message to support women going through the experience
- **The flame grows** — diyos scale up and the page glow intensifies as more affirmations are added by the community 
...
| Validation | Zod 4                                               |
| AI / LLM   | Groq — `llama-3.3-70b-versatile` / Anthropic - `SONNET 4` (Aangan Bot + translation) |
